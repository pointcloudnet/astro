...
function bldTable(a){
    table = new Tabulator("#example-table", {
        ...
        ,columns:[ //set column definitions for imported table data
            ...
            ,{title:"created", field:"created",responsive:0,width:"30%"}
           ,{title:"Title", field:"ttl",responsive:0,width:"35%"}
            ,{title:"URL", field:"url",formatter:"link",formatterParams:{ target: "_blank" },responsive:0,width:"20%"}
            ,{title:"Fav", field:"fav",responsive:0,width:"15%"}
